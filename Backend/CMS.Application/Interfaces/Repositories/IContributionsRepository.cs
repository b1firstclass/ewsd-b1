...
namespace CMS.Application.Interfaces.Repositories
{
    public interface IContributionsRepository
    {
        ...
        Task<PagedResult<Contribution>> GetPagedByUserAsync(Guid userId, int skip, int take, Guid? contributionWindowId = null, string? status = null, string? searchKeyword = null, bool? isActive = null);
        Task<PagedResult<Contribution>> GetPagedByFacultiesAsync(Guid coordinatorUserId, IReadOnlyCollection<Guid> facultyIds, int skip, int take, Guid? contributionWindowId = null, string? status = null, string? searchKeyword = null, bool? isActive = null);
